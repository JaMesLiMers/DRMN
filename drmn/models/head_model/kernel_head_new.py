...
class ConvKernelHead(nn.Module):
    ...
    def __init__(self,
        ...
        self.init_kernels = nn.Linear(in_channels, in_channels)
    ...
    def _decode_init_proposals(self, img, lang_feat):
        loc_feats, mlvl_feat = self.localization_fpn(img) # ./semantic_fpn_wrapper.py, row 190
        # loc_feats: [B, 256, H//8, W//8]
        loc_feats = self.loc_convs(loc_feats) #[2,256,100,152]
        # loc_feats: [B, 256, H//8, W//8]

        proposal_feats = self.init_kernels(lang_feat)
        ...
        return proposal_feats, loc_feats, mlvl_feat, mask_preds
    ...
    def forward(self, img, lang_feat):
        ...
        (proposal_feats, x_feats, mlvl_feat, mask_preds) = results
        ...
        return proposal_feats, x_feats, mlvl_feat, scaled_mask_preds
